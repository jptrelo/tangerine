...
<div id="editorial_block_center" class="editorial_block row">
	<div class="editorial-logo-block col-xs-12 col-sm-5 col-md-5 pull-right">
	...
	<div class="col-xs-12 col-sm-10 col-md-11" style="margin:auto;float:none;">		
		<div class="editorial-text-block col-xs-12 col-sm-7 col-md-7">
